...
6. **Save PRD:** Save as `PRD-[n]-[feature-description].md` in the `/tasks` directory
7. **Generate Context Document:** Create context.md baseline to capture design decisions and patterns
...
- **Context Documentation:** Use `context-template.md` for design decision documentation
...
- `PRD-0001-user-authentication.md`
- `PRD-0002-payment-processing.md`
